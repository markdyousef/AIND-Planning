...
class PgNode():
    ...
    def is_mutex(self, other) -> bool:
        ...
        :return: bool
            True if this node and the other are
            marked mutually exclusive (mutex)
        """
...
class PgNode_a(PgNode):
    ...
    def __init__(self, action: Action):
        ...
        Instance variables calculated:
            ...
            However, when this node is created,
            it is not yet connected to the graph
...
class PlanningGraph():
    ...
    def create_graph(self):
        ...
        It has no parents and includes all of the literal fluents
        that are part of the initial state passed to the constructor.
        At the start of a problem planning search,
        this will be the same as the initial state of the problem.
        However, the planning graph
        can be built from any state in the Planning Problem
        ...
        if (len(self.s_levels) != 0) or (len(self.a_levels) != 0):
            raise Exception(
                ...
                'construct a new planning graph for each new'
        ...
        # continue to build the graph alternating A, S levels
        # until last two S levels contain the same literals,
    ...
    def add_action_level(self, level):
        ...
        #   to see if a proposed PgNode_a has prenodes
    ...
    def update_a_mutex(self, nodeset):
        ...
        if the planning graph is a serial planning graph
        and the pair are nonpersistence actions
    ...
    def competing_needs_mutex(
        ...
        for parent in node_a1.parents:
            for other_parent in node_a2.parents:
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for parent in node_s1.parents:
            for other_parent in node_s2.parents:
                if node_s1 in other_parent.effnodes:
                    return False
                if node_s2 in parent.effnodes:
                    return False
                if parent.is_mutex(other_parent):
                    return True
